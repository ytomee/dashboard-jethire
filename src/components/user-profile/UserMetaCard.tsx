...
import DropzoneComponent from "../form/form-elements/EditPFP";
        ...
        <div className="flex flex-col gap-5 xl:flex-row xl:items-center xl:justify-between">
          <div className="flex flex-col items-center w-full gap-6 xl:flex-row">
            <div className="relative w-20 h-20 group rounded-full overflow-hidden border border-gray-200 dark:border-gray-800">
              <a onClick={openModal} className="block w-full h-full">
                <Image
                  width={80}
                  height={80}
            ...
            <div className="order-3 xl:order-2">
              ...
              <div className="flex flex-col items-center gap-1 text-center xl:flex-row xl:gap-3 xl:text-left">
                <p className="text-sm text-gray-500 dark:text-gray-400">{user.companyName ? `${user.companyName} - ` : ""} {readableRole}</p>
                <div className="hidden h-3.5 w-px bg-gray-300 dark:bg-gray-700 xl:block"></div>
                <p className="text-sm text-gray-500 dark:text-gray-400">{user.city}, {user.country}</p>
              </div>
            </div>
